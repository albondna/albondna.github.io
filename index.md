...
<body>
    ...
    <section>   
        <h3 style="background-color:F8F8FF>*一些自我介绍</h3>
        <p>目前在浙江大学海洋学院学习海洋科学，方向是物理海洋。</p>
    </section>


    <section>   
        <h3 style="background-color:F8F8FF>*制作这个的目的</h3>
    ...
    <section>   
        <h3 style="background-color:F8F8FF>*目前内容</h3>
    ...
    <section>   
         <h3 style="background-color:F8F8FF>*未来的更新打算</h3>
